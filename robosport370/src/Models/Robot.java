...
public class Robot implements Cloneable {
     ...
     * 
     * @param teamNumber
     *            The number assigned to the team
     * @param memberNumber
     *            The number assigned to the robot
     */
    ...
    /**
     * @param newHexPosition
     *            the hex number to move this robot to
     */
     ...
     *             an exception thrown by forth interpretor if runtime error
     *             occurs
