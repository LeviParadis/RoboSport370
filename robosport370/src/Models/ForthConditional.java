...
public class ForthConditional implements ForthWord {
     ...
     * 
     * @param stringList
     *            a list of forth words that are contained in the if statement
     * @throws ForthParseException
     *             thrown if it encounters multiple else statements
     */
    ...
    /**
     * @param result
     *            a bool indicating whether to return the true or the false
     *            branch
