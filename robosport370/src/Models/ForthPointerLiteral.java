...
public class ForthPointerLiteral implements ForthWord {
     ...
     * @param r
     *            the robot running the program, so the variable can be verified
     * @throws ForthParseException
     *             thrown if the string doesn't represent one of the robot's
     *             variables
     */
     ...
     *            the robot that is running the program
     * @param newValue
     *            the new value to save to the variable
     */
