...
public class ForthBoolLiteral implements ForthWord {
     ...
     * @param wordString a string containing true or false
     * @throws ForthParseException thrown if the string doesn't represent a bool
     */
     ...
     * @param value the value to create a forth bool with
     */
