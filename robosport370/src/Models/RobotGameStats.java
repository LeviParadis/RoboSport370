...
public class RobotGameStats {
    ...
    /**
     * Create a new robot stats instance to store the statistics for a robot
     * file
     * 
     * @param wins
     *            the number of wins this robot has in its history from previous
     *            matches
     * @param losses
     *            the number of losses this robot has in its history from
     *            previous matches
     * @param executions
     *            the number of times this robot has been executed in it's
     *            history
     * @param gamesDied
     *            the number of times this robot has died in it's previous games
     * @param gamesSurvived
     *            the number of times this robot has survived it's previous
     *            games
     * @param damageGiven
     *            the total amount of damage this robot has caused in it's
     *            history
     * @param damageRecieved
     *            the total amount of damage the robot has received in it's
     *            history
     * @param kills
     *            the total number of kills the robot has achieved in it's
     *            history
     * @param distanceMoved
     *            the total distance the robot has moved in it's history
     */
    public RobotGameStats(long wins, long losses, long executions, long gamesDied, long gamesSurvived, long damageGiven,
            long damageRecieved, long kills, long distanceMoved) {
        this.wins = wins;
        this.losses = losses;
    ...
    /**
     * at the end of a match, this function should be called to update the
     * robot's win stats
     * 
     * @param numWins
     *            the amount of instances of this robot that was on the winning
     *            team
     * @param numLosses
     *            the amount of instances of this robot that was on losing teams
     */
