...
public class EditRobotController extends AddRobotController {
     ...
     * 
     * @param name
     *            the text in the name field at the time of the button press
     * @param team
     *            the text in the team field at the time of the button press
     * @param forth
     *            the text in the forth field at the time of the button press
     * @param movesLeft
     *            the number of moves for the checkbox values at the time of the
     *            button press
     * @param firePower
     *            the amount of power for the checkbox values at the time of the
     *            button press
     * @param health
     *            the amount of health for the checkbox values at the time of
     *            the button press
     */
    ...
    /**
     * Called when the user pressed the retire button Tells the Json Interpreter
     * to retire the selected robot
     */
