...
/**
 * @author Corey
 * @author Levi setupController handles the main menu and setup screens while
...
public class setupController implements PickRobotsDelegate {
     ...
     * if(this.selectedTeams.size() < 6){
     * 
     * Queue<Robot> robotList = JsonInterpreter.listRobots(true, null, null,
     * null, null, null, null, null, null); Team newTeam = new Team(robotList,
     * this.selectedTeams.size()); this.selectedTeams.add(newTeam);
     * 
     * System.out.println(this.selectedTeams); } else { System.out.println(
     * "already 6 teams"); }
     */
    // }
