    ...
    public int moveRobot(Robot robotToMove, int TeamNumber, int range, int direction, int movesLeft)
        ...
        if (bestPath == null) {
            ...
            while (iter.hasNext()) {
                ...
                view.moveRobot((int) (robotToMove.getTeamNumber()), (int) (robotToMove.getMemberNumber()),
                        currentDirection);
            }
        }
        return movesLeft;
