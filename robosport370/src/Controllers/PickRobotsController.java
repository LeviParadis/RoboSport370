...
public class PickRobotsController {
    ...
    public void notifyConfirm(Queue<Robot> robotList){
        //if the robot list matches our requirements, we tell the delegate that we have successfully picked some robots
    ...
    /**
     * Called when the user presses the search button. Should return a list of robots to update the view with
